...
public abstract class AbstractLuceneTransactionEngineTests extends AbstractTransactionEngineTests {
    ...
    protected CompassSettings buildCompassSettings() {
        ...
        settings.setSetting(CompassEnvironment.Transaction.ISOLATION_CLASS, LuceneTransaction.class.getName());
        return settings;
    }

    public void testSettings() {
        assertEquals(LuceneTransaction.class.getName(), getSettings().getSetting(
