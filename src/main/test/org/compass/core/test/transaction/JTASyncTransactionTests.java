 ...
 * @author kimchy
 */
public class JTASyncTransactionTests extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        CompassConfiguration conf = new CompassConfiguration()
                .configure("/org/compass/core/test/transaction/compass.jtasync.cfg.xml");
    ...
    public void testInnerUTManagement() throws Exception {
        ...
        assertEquals(JTASyncTransaction.class, tr.getClass());
