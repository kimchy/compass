 ...
 * @author kimchy
 */
public class PropertiesSpellCheckTests  extends AbstractTestCase {

    protected String[] getMappings() {
        return new String[]{"spellcheck/properties/mapping.cpm.xml"};
    }
    ...
    protected void addSettings(CompassSettings settings) {
        ...
        settings.setSetting(LuceneEnvironment.SpellCheck.PROPERTY, "value1, value2");
    }
