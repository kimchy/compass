 ...
 * @author kimchy
 */
public class IncludeAllPropertiesMappingSpellCheckTests extends AbstractTestCase {
    ...
    protected void addSettings(CompassSettings settings) {
        ...
        settings.setBooleanSetting(LuceneEnvironment.SpellCheck.INCLUDE_ALL_PROPERTIES, true);
    }
