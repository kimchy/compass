...
package org.compass.core.test.json.object.jackson;
...
import org.compass.core.json.jackson.converter.JacksonContentConverter;
import org.compass.core.test.AbstractTestCase;

/**
 * @author kimchy
 */
public class SimpleJacksonJsonObjectTests extends AbstractTestCase {

    protected String[] getMappings() {
        return new String[]{"json/object/grails/mapping.cpm.xml"};
    }
    ...
    public void testDotPath() {
        ...
        JsonObject grailsJsonObject = (JsonObject) session.load("a", 1);
        assertTrue(grailsJsonObject instanceof JacksonJsonObject);
    ...
    public void testSimpleJsonObject() {
        ...
        JsonObject loadedJsonObject = (JsonObject) session.load("a", 1);
        assertTrue(loadedJsonObject instanceof JacksonJsonObject);
    ...
    public void testSimpleJsonObjectDouble() {
        ...
        JsonObject loadedJsonObject = (JsonObject) session.load("b", 1);
        assertTrue(loadedJsonObject instanceof JacksonJsonObject);
