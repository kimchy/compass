...
package org.compass.gps.device.jpa.eclipselink;
 ...
 * @author kimchy
 */
public class EclipseLinkSimpleJpaGpsDeviceTests extends AbstractSimpleJpaGpsDeviceTests {
    ...
    protected EntityManagerFactory doSetUpEntityManagerFactory() {
        return new PersistenceProvider().createEntityManagerFactory("eclipselink", new HashMap());
    }
}