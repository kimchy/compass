...
public class TransactionalRunnableWithTr implements Runnable {
    ...
    public TransactionalRunnableWithTr(TransactionContext transactionContext, Runnable delegate) {
        this.transactionContext = transactionContext;
        this.delegate = delegate;
    }

    public void run() {
        transactionContext.execute(new TransactionContextCallbackWithTr<Object>() {
