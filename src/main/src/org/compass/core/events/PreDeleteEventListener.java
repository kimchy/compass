...
/**
 * An event called before an object is deleted. Maps to the <code>delete</code> opeation on the
 * session.
 *
...
public interface PreDeleteEventListener {
    ...
    /**
     * An event called before an object is created. Maps to the <code>delete</code> opeation on the
