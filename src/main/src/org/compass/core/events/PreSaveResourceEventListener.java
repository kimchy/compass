 ...
 * Maps to the <code>save</code> opeation on the session.
 *
...
public interface PreSaveResourceEventListener {
    ...
    /**
     * An event called before an object is saved and accepts the Resource that represents it.
     * Maps to the <code>save</code> opeation on the session. Returns if this operation should be filtered or not.
     */
