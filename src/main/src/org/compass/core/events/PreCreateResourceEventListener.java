 ...
 * Maps to the <code>create</code> opeation on the session.
 *
...
public interface PreCreateResourceEventListener {
    ...
    /**
     * An event called before an object is created and accepts the Resource that represents it.
     * Maps to the <code>create</code> opeation on the session. Returns if this operation should be filtered or not.
     */
