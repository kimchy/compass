 ...
 * @author kimchy
 */
public interface SearchEngineQueryFilterBuilder {

    public static interface SearchEngineToQueryFilter {

        SearchEngineQueryFilter toFilter();
    }

    public static interface SearchEngineBooleanQueryFilterBuilder extends SearchEngineToQueryFilter {

        void and(SearchEngineQueryFilter filter);

        void or(SearchEngineQueryFilter filter);

        void andNot(SearchEngineQueryFilter filter);

        void xor(SearchEngineQueryFilter filter);
    }
    ...
    SearchEngineBooleanQueryFilterBuilder bool();
}
