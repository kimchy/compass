...
public final class Utils {
    ...
    private final static String providerProp =
        "org.compass.core.util.backport.java.util.concurrent.NanoTimerProvider";
     ...
     * <code>org.compass.core.util.backport.java.util.concurrent.NanoTimerProvider</code>.
     ...
     * org.compass.core.util.backport.java.util.concurrent.locks.Condition#signal}
     * method for this
     * <tt>Condition</tt> and the current thread happens to be chosen as the
     * thread to be awakened; or
     * <li>Some other thread invokes the {@link
     * org.compass.core.util.backport.java.util.concurrent.locks.Condition#signalAll}
     * method for this
     * <tt>Condition</tt>; or
