 ...
 * {@link org.compass.gps.device.jdbc.snapshot.JdbcSnapshotEventListener#configure(ConfigureSnapshotEvent)}.Holds
...
public class ConfigureSnapshotEvent extends AbstractSnapshotEvent {
    ...
    public ConfigureSnapshotEvent(Connection connection, JdbcDialect dialect, List mappings) {
