 ...
 * {@link DefaultJpaEntitiesLocator} since it works with both xml files and annotatios.
 *
 * @author kimchy
 */
public class EclipseLinkJpaEntitiesLocator implements JpaEntitiesLocator {
     ...
     *
     * <p>Implementation filteres out inherited Eclipse mappings, since the select query
     ...
     * @param classDescriptor The Eclipse class descriptor
