 ...
 * @author kimchy
 */
class TerracottaManagerUtilInstanceLock extends Lock {

    private String lockName;

    public TerracottaManagerUtilInstanceLock(String lockName) {
    ...
    public String toString() {
        return "TerracottaManagerUtilInstanceLock: " + lockName;
    }
}