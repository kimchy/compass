 ...
 * {@link org.compass.gps.device.hibernate.scrollable.snapshot.HibernateSnapshotEventListener#onCreateAndUpdate(CreateAndUpdateSnapshotEvent)}.
 * Holds the
 ...
 * {@link org.compass.gps.device.hibernate.scrollable.snapshot.HibernateAliasRowSnapshot} for all the
...
public class CreateAndUpdateSnapshotEvent extends AbstractSnapshotEvent {
    ...
    public CreateAndUpdateSnapshotEvent(Session session, ResultSetToResourceMapping mapping,
