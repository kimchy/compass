...
- Spring Framework 2.0 (http://www.springframework.org) (includes spring-ojb which has moved)
- required for building compass
...
- Oracle Toplink Essential Reference implementation of JPA (part of glass fish) v2 build 25 (http://www.oracle.com/technology/products/ias/toplink/jpa)
- required for building compass
