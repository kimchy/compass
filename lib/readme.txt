...
- Java Assist 3.3 (Required by Hibernate EntityManager) (taken form EntityManager 3.2 CR2)
- required for building compass
...
- JBoss Archive Browsing 5.0.0alpha build: CVSTag=HEAD date=200607201 119 (taken form EntityManager 3.2 CR2)
- required for building compass
...
- Spring Framework 2.0 RC4 (http://www.springframework.org) (includes spring-ojb which has moved)
- required for building compass
...
- Oracle Toplink Essential Reference implementation of JPA (part of glass fish) v2 build 15 (http://www.oracle.com/technology/products/ias/toplink/jpa)
- required for building compass
